...
def Conv(
    ...
    net = nn.Sequential(
        nn.Conv3d(dim_in, dim_out, 3, stride = 1, padding = 1),
...
#     # depth = 4,                        # number of MaxViT blocks per stage, which consists of MBConv, block-like attention, grid-like attention
...
#     dropout = 0.0                     # dropout
# ).to('cuda:1')
# img = torch.randn(2, 256, 32, 32, 24).to('cuda:1')
